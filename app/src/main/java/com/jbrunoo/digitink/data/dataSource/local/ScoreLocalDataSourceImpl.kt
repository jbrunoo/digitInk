...
class ScoreLocalDataSourceImpl @Inject constructor(
    private val dataStore: DataStore<Preferences>,
) : ScoreLocalDataSource {

    override fun readLocalScore(): Flow<Score> = dataStore.data
        .catch { exception ->
        ...
        .map { preferences ->
            Score(
                ...
                infiniteMode = preferences[longPreferencesKey(Constants.DATASTORE_KEY_INFINITE)]
                    ?: 0,
            )
        }
